    ...
    <main className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
      <div className="space-y-6 bg-slate-50 p-6 rounded-xl border border-slate-200">
        ...
        <div className="p-3 bg-white rounded-lg border border-slate-300 text-sm">
            ...
            <p className="text-slate-900 font-mono tracking-wider text-base">10%</p>
        </div>
      </div>
      <div className="space-y-6">
        ...
        <p className="text-xs text-slate-500 pt-4 px-1">*Catatan: PPh Final 10% untuk sewa tanah dan/atau bangunan.</p>
      </div>
    </main>
  );
};